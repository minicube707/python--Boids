...
def calcul_animation(WIDTH, HEIGHT, list_chuck, border):
    with mp.Pool() as pool:
        ...
        result_1 = pool.apply_async(Processing1, (WIDTH, HEIGHT, list_chuck, border))
        result_2 = pool.apply_async(Processing2, (WIDTH, HEIGHT, list_chuck, border))
        
       
        result_1_value = result_1.get()  # This will block until result_1 is ready and return the result
        result_2_value = result_2.get()  # This will block until result_2 is ready and return the result

    res = result_1_value
    res.extend(result_2_value)
    return res
...
def main():
    ...
    while running:
        ...
        list_animoids = calcul_animation(WIDTH, HEIGHT, list_chuck, border)
