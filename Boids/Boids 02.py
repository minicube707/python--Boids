...
class Boids():
    ...
    def update(self, index, list_boids):
        ...
        distance_alignement = self.distance_alignement
        ...
        if len(list_boids) > 1:
            ...
            #Séparation 
            if nearest_neighbor_distance < distance_separation:
            ...
            #Alignement
            elif nearest_neighbor_distance < distance_alignement:
                nb_neighbor = 0
                all_orienetatoin = 0
            ...
            #Cohesion
            elif nearest_neighbor_distance < distance_cohesion:
                angle_to_nearest_boids = np.arctan2(nearest_neighbor_distance_y, nearest_neighbor_distance_x)
...
def main():
    ...
    boid_1 = Boids(math.pi, np.array([WIDTH//2, HEIGHT//2]),        BLACK, 20, 3, 5, 120, 50, 20)
    boid_2 = Boids(math.pi, np.array([2*WIDTH//3, HEIGHT//2]),      BLACK, 20, 3, 5, 120, 50, 20)
    boid_3 = Boids(math.pi, np.array([WIDTH//3, HEIGHT//2]),        BLACK, 20, 3, 5, 120, 50, 20)
    boid_3 = Boids(math.pi, np.array([WIDTH//2, 2*HEIGHT//3]),      BLACK, 20, 3, 5, 120, 50, 20)
    boid_4 = Boids(math.pi/3, np.array([WIDTH//2, HEIGHT//3]),      BLACK, 20, 3, 5, 120, 50, 20)
    boid_5 = Boids(math.pi/3, np.array([WIDTH//2, 2*HEIGHT//3]),    BLACK, 20, 3, 5, 120, 50, 20)
    boid_6 = Boids(math.pi/2, np.array([WIDTH//2, 2*HEIGHT//3]),    BLACK, 20, 3, 5, 120, 50, 20)
    boid_7 = Boids(math.pi/2, np.array([WIDTH//2, 2*HEIGHT//3]),    BLACK, 20, 3, 5, 120, 50, 20)
    boid_8 = Boids(math.pi/2, np.array([WIDTH//2, 2*HEIGHT//3]),    BLACK, 20, 3, 5, 120, 50, 20)
    boid_9 = Boids(math.pi/2, np.array([WIDTH//2, 2*HEIGHT//3]),    BLACK, 20, 3, 5, 120, 50, 20)
